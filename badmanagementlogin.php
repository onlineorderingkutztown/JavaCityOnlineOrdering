...
<div class="container">
<form class="form-signin" name="login" action="badmanagementlogin.php" method="POST">
  ...
  <h1 class="h3 mb-3 font-weight-normal">Kutztown University Manager Login</h1>
	  ...
	  <br><br>
	<p> Don't have an account? Talk to another Manager. </p>
	<br><br>
</form>
</div class="container">
